...
/**
 * Denotes a list (ordered and non-unique multiple feature) with
 * specified bounds.
 *
 ...
 */
public interface MList<E, L extends ILowerBound, U extends IUpperBound> extends MCollection<E, L, U> {
