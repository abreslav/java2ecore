...
/**
 * Denotes a set (non-ordered and unique multiple feature) with
 * specified bounds.
 *
 ...
 */
public interface MSet<E, L extends ILowerBound, U extends IUpperBound> extends MCollection<E, L, U> {
